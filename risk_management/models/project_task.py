...
# Copyright (C) 2019 PriseHub <https://www.prisehub.com>.
...
class ProjectProject(models.Model):
    ...
    risk_ids = fields.One2many("risk.management.risk", "project_id", "Project Risks")

    risk_count = fields.Integer(compute="_risk_count", type="integer")
